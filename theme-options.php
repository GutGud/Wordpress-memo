 ...
 * Создание массивов для выбора ваших скинов где: blue, pink, purple and tomato
 * есть имена css файлов ваших стилей
 */
	...
	<div class="wrap">
		...
		<form method="post" action="options.php">
			...
			<table class="form-table">
				 ...
				 */
				?>
				<tr valign="top"><th scope="row"><?php _e( 'Выберите цвет скина', 'sampletheme' ); ?></th>
					<td>
